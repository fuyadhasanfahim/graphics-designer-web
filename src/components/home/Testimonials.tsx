    ...
    return (
        <div>
            <div className="flex items-center justify-between w-full absolute z-0">
                ...
                <div className="w-4/6 ml-16 bg-green-50 h-full" />
            </div>
            <div className="xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container relative z-40">
                ...
                >
                                    ...
                                    <div className="md:w-1/3 lg:w-1/3 xl:ml-32 md:ml-20 md:mt-0 mt-4 flex flex-col justify-between">
                                        <div>
                                            <h1 className="text-2xl font-semibold xl:leading-loose text-gray-800">
                                                Some of the best work that was
                                                done!
                                            </h1>
                                            <p className="text-base font-medium leading-6 mt-4 text-gray-600">
                                                Our core values are at the heart
                                                of all that we do. They are
                                                integrated into our daily work
                                                lives and help us to remember
                                                our customers always comes
                                                first, the last thank you should
                                ...
                                <div className="mt-14 md:flex">
                                    <div className="relative lg:w-1/2 sm:w-96 xl:h-96 h-80">
                                        <img
                                            ...
                                            className="w-full h-full flex-shrink-0 object-fit object-cover rounded"
                                        />
                                        <div className="w-32 md:flex hidden items-center justify-center absolute top-0 -mr-16 -mt-14 right-0 h-32 bg-green-100 rounded-full">
                                            <img
                                                src="https://tuk-cdn.s3.amazonaws.com/can-uploader/testimonial-svg1.svg"
                                                alt="commas"
                                            />
                    ...
                    <div className="flex items-center mt-8">
                        <ButtonBack
                            className="cursor-pointer ring-1 ring-green-500 rounded-full p-2 bg-green-100 shadow-md hover:scale-105 duration-300 ease-linear transition-transform"
                            role="button"
                        ...
                        <ButtonNext
                            ...
                            className="cursor-pointer ml-2 ring-1 ring-green-500 rounded-full p-2 bg-green-100 shadow-md hover:scale-105 duration-300 ease-linear transition-transform"
                        >
                            <img
