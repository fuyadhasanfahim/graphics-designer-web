        ...
        <>
            <div className="container mx-auto pt-16 mb-20">
                <div className="lg:flex">
                    ...
                    <div className="xl:w-3/5 lg:w-3/5 bg-green-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
                        <form
                            id="contact"
                        ...
                        >
                                ...
                                <div className="w-2/4 max-w-xs mb-6 xl:mb-0">
                                    <div className="flex flex-col">
                                        ...
                                        <input
                                            ...
                                            name="full_name"
                                            type="text"
                                            className="focus:outline-none focus:border focus:border-green-700 font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border bg-white"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="w-full mt-6">
                                <div className="flex flex-col">
                                    ...
                                    <textarea
                                        name="message"
                                        className="border-gray-300 border mb-4 rounded py-2 text-sm outline-none resize-none px-3 focus:border focus:border-green-700 bg-white"
                                        rows={8}
                                        id="message"
                                        defaultValue={''}
                                    />
